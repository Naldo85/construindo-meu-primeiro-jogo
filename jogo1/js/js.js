...
function placar() {
    ...
    $("#fim").html("<h1> Fase Conclida </h1><p>Pontos adquiridos: " + 
    pontos + "</p>" + "Militares Salvos: " + salvos + "</p>" + "Militares Mortos: " + 
    perdidos  + "<div id='reinicia' onClick=reiniciaJogo()><h3>Proxima Fase</h3></div>");
  }        
...
function gameOver() {
    ...
    $("#fim").html("<h1> Game Over </h1><p>Pontuação adquirida: " + pontos + "</p>" + "Limte de pontos não atingido!" 
    + "</p>" + "<div id='reinicia' onClick=reiniciaJogo()><h3>Jogar Novamente</h3></div>");
        
 }  // Fim da função gameOver();S
